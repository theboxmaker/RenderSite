...
<head>
    ...
    <title>Zachary Tucker's Web Projects - Home</title>
    <script src="https://lint.page/kit/67ff88.js" crossorigin="anonymous"></script>
</head>

<body>

    <?php include "$base/web250/components/header.html"; ?>
    ...
    <main>
        ...
        <p>
            ...
            I like to spend my free time outside, either rock climbing or golfing!
        ...
        <p>
            ...
            <a href="web250/introduction.php">introduction</a>.
        </p>
    </main>

    <?php include "$base/web250/components/footer.html"; ?>
